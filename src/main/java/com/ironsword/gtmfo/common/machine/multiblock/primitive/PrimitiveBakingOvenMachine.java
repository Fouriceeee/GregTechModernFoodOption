...
public class PrimitiveBakingOvenMachine extends PrimitiveWorkableMachine implements IUIMachine {
    ...
    public ModularUI createUI(Player entityPlayer) {
        return new ModularUI(176, 166, this, entityPlayer)
                ...
                .widget(new SlotWidget(fuelItems.storage, 0, 7, 42, true, true)
                        .setBackgroundTexture(GuiTextures.PRIMITIVE_SLOT))
                // input
                .widget(new SlotWidget(importItems.storage, 0, 31, 24, true, true)
                        .setBackgroundTexture(GuiTextures.PRIMITIVE_SLOT))
                .widget(new SlotWidget(importItems.storage, 1, 55, 24, true, true)
                        .setBackgroundTexture(GuiTextures.PRIMITIVE_SLOT))
                .widget(new SlotWidget(importItems.storage, 2, 31, 42, true, true)
                        .setBackgroundTexture(GuiTextures.PRIMITIVE_SLOT))
                .widget(new SlotWidget(importItems.storage, 3, 55, 42, true, true)
                        .setBackgroundTexture(GuiTextures.PRIMITIVE_SLOT))
                // output
                .widget(new SlotWidget(exportItems.storage, 0, 115, 24, true, false)
                        .setBackgroundTexture(GuiTextures.PRIMITIVE_SLOT))
                .widget(new SlotWidget(exportItems.storage, 1, 133, 24, true, false)
                        .setBackgroundTexture(GuiTextures.PRIMITIVE_SLOT))
                .widget(new SlotWidget(exportItems.storage, 2, 115, 42, true, false)
                        .setBackgroundTexture(GuiTextures.PRIMITIVE_SLOT))
                .widget(new SlotWidget(exportItems.storage, 3, 133, 42, true, false)
                        .setBackgroundTexture(GuiTextures.PRIMITIVE_SLOT))
                // heat bar
                ...
                .widget(new ImageWidget(87, 34, 20, 15,
