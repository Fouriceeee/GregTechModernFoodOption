...
public class GTMFOEffects {
    ...
    public static final RegistryObject<MobEffect> SNOW = register("snow", MobEffectCategory.NEUTRAL, 0,
            "Snow-Protected", "霜之守护");
    public static final RegistryObject<MobEffect> VENTING = register("venting", MobEffectCategory.NEUTRAL, 0, "Venting",
            "风口传送");
    public static final RegistryObject<MobEffect> CHORUS = register("chorus", MobEffectCategory.NEUTRAL, 0,
            "Enhanced Chorus", "Enhanced Chorus");

    private static RegistryObject<MobEffect> register(String name, MobEffectCategory category, int color, String enLang,
                                                      String cnLang) {
