...
public class BreadRecipes {
    ...
    private static void bbb(Consumer<FinishedRecipe> provider) {
        ...
        GTMFORecipeTypes.BAKING_OVEN_RECIPES.recipeBuilder(id("bun"))
                ...
                .duration(150).addData("temp", 490).save(provider);
        ...
        GTMFORecipeTypes.SLICER_RECIPES.recipeBuilder(id("bread_slice"))
                ...
                .EUt(18).duration(30).save(provider);
        RecipeUtils.addFoodSmeltingRecipe(provider, "toast", GTMFOItems.BREAD_SLICE.asStack(),
    ...
    private static void cake(Consumer<FinishedRecipe> provider) {
        ...
        GTMFORecipeTypes.BAKING_OVEN_RECIPES.recipeBuilder(id("cake_bottom_baked"))
                ...
                .duration(500).addData("temp", 445).save(provider);
    ...
    private static void burger(Consumer<FinishedRecipe> provider) {
        VanillaRecipeHelper.addShapelessRecipe(provider, id("burger_veggie_by_hand"),
                GTMFOItems.BURGER_VEGGIE.asStack(),
                GTMFOItems.BUN_SLICED.asStack(),
        ...
        VanillaRecipeHelper.addShapelessRecipe(provider, id("burger_cheese_by_hand"),
                GTMFOItems.BURGER_CHEESE.asStack(),
                GTMFOItems.BUN_SLICED.asStack(),
