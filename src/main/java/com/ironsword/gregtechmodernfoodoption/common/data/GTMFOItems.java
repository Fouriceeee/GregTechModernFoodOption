...
public class GTMFOItems {
    ...
    public static final ItemEntry<Item> BURGER_MEAT   = item("burger_meat",  "Meat Burger",  "牛肉汉堡","burger/meat");
    ...
    public static final ItemEntry<Item> CAPLET_GEL           = item("caplet_gel"          ,"Gel Caplet"             ,"明胶胶囊"        ,"caplet/gel"          );
    public static final ItemEntry<Item> CAPLET_PARACETAMOL   = item("caplet_paracetamol"  ,"Paracetamol Caplet"     ,"对乙酰氨基酚胶囊","caplet/paracetamol"  );
    public static final ItemEntry<Item> CAPLET_PLUTONIUM_241 = item("caplet_plutonium_241","Plutonium-241 Caplet"   ,"钚-241胶囊"      ,"caplet/plutonium_241");
    public static final ItemEntry<Item> CAPLET_CHORUS        = item("caplet_chorus"       ,"Fermented Chorus Caplet","发酵紫颂果胶囊"  ,"caplet/chorus"       );
    public static final ItemEntry<Item> CAPLET_VIBRANT       = item("caplet_vibrant"      ,"Vibrant Caplet"         ,"Vibrant Caplet"  ,"caplet/vibrant"      );

    //cheese
    public static final ItemEntry<Item> CHEDDAR_BLOCK     = item("cheddar_block"    ,"Cheddar Block"    ,"块状切达奶酪"          ,"cheese/cheddar_block"    );
    public static final ItemEntry<Item> CHEDDAR_SLICE     = item("cheddar_slice"    ,"Cheddar Slice"    ,"切达奶酪片"            ,"cheese/cheddar_slice"    );
    ...
    public static final ItemEntry<Item> MOZZARELLA_BALL   = item("mozzarella_ball"  ,"Mozzarella Ball"  ,"马苏里拉奶酪球"        ,"cheese/mozzarella_ball"  );
    ...
    public static final ItemEntry<Item> GORGONZOLA_TRIANGULAR_SLICE    = item("gorgonzola_triangular_slice"   ,"Gorgonzola Triangular Slice"   ,"戈贡佐拉奶酪三角"      ,"cheese/gorgonzola_triangular_slice"   );
    ...
    public static final ItemEntry<Item> COFFEE           = item("coffee"          ,"Coffee Cup"          ,"咖啡"    ,"coffee/normal"   );
    public static final ItemEntry<Item> COFFEE_ENERGIZED = item("coffee_energized","Energized Coffee Cup","提神咖啡","coffee/energized");
    ...
    public static final ItemEntry<Item> POPCORN_BAG            = item("popcorn_bag"           ,"Popcorn Bag"           ,"袋装爆米花"  ,"corn/popcorn_bag"      );
    ...
    //drink
    public static final ItemEntry<Item> ANTAF            = item("antaf"           ,"Antaf™"         ,"Antaf™"     ,"drink/antaf"           );
    public static final ItemEntry<Item> BEER             = item("beer"            ,"Beer"            ,"啤酒"        ,"drink/beer"            );
    public static final ItemEntry<Item> ETIRPS           = item("etirps"          ,"Etirps™"        ,"碧雪™"      ,"drink/etirps"          );
    public static final ItemEntry<Item> ETIRPS_CRANBERRY = item("etirps_cranberry","Etirps Cranberry","蔓越莓味碧雪","drink/etirps_cranberry");
    public static final ItemEntry<Item> JUICE_APPLE      = item("juice_apple"     ,"Apple Juice"     ,"苹果汁"      ,"drink/juice_apple"     );
    public static final ItemEntry<Item> JUICE_ORANGE     = item("juice_orange"    ,"Orange Juice"    ,"橙汁"        ,"drink/juice_orange"    );
    public static final ItemEntry<Item> LENINADE         = item("leninade"        ,"Leninade"        ,"列宁檬汁"    ,"drink/leninade"        );
    public static final ItemEntry<Item> MINERAL_WATER    = item("mineral_water"   ,"Mineral Water"   ,"矿泉水"      ,"drink/mineral_water"   );
    public static final ItemEntry<Item> NILK             = item("nilk"            ,"Nilk"            ,"硅岩风味乳"  ,"drink/nilk"            );
    public static final ItemEntry<Item> RED_WINE         = item("red_wine"        ,"Red Wine"        ,"红葡萄酒"    ,"drink/red_wine"        );
    public static final ItemEntry<Item> SPARKLING_WATER  = item("sparkling_water" ,"Sparkling Water" ,"气泡水"      ,"drink/sparkling_water" );
    public static final ItemEntry<Item> VODKA            = item("vodka"           ,"Vodka"           ,"伏特加"      ,"drink/vodka"           );
    public static final ItemEntry<Item> WHITE_WINE       = item("white_wine"      ,"White Wine"      ,"白葡萄酒"    ,"drink/white_wine"      );
    ...
    public static final ItemEntry<Item> PIZZA_MINCE_MEAT     = item("pizza_mince_meat"    ,"Mince Meat Pizza"            ,"肉末披萨"      ,"pizza/mince_meat"    );
    public static final ItemEntry<Item> PIZZA_MINCE_MEAT_RAW = item("pizza_mince_meat_raw","Raw Mince Meat Pizza"        ,"生肉末披萨"    ,"pizza/mince_meat_raw");
    ...
    public static final ItemEntry<Item> POTATO_ON_A_STICK        = item("potato_on_a_stick"       ,"Roasted Potato on a Stick","烤马铃薯棒"        ,"potato/stick"            );
    ...
    //smore
    public static final ItemEntry<Item> SMORE_ONE        = item("smore_one"       ,"S'more S'mingot"                          ,"巧克力棉花糖夹心饼干"        ,"smore/one"       );
    public static final ItemEntry<Item> SMORE_TWO        = item("smore_two"       ,"MoreS'more DoubleS'mingot"                ,"双层巧克力棉花糖夹心饼干"    ,"smore/two"       );
    public static final ItemEntry<Item> SMORE_FOUR       = item("smore_four"      ,"FourS'more QuadS'mingot"                  ,"四层巧克力棉花糖夹心饼干"    ,"smore/four"      );
    public static final ItemEntry<Item> SMORE_EIGHT      = item("smore_eight"     ,"EightS'more OctoS'mingot"                 ,"八层巧克力棉花糖夹心饼干"    ,"smore/eight"     );
    public static final ItemEntry<Item> SMORE_SIXTEEN    = item("smore_sixteen"   ,"SixteenS'more HexadecaS'mingot"           ,"十六层巧克力棉花糖夹心饼干"  ,"smore/sixteen"   );
    public static final ItemEntry<Item> SMORE_THIRTY_TWO = item("smore_thirty_two","Half-stack-o'-S'more TriacontadyoS'mingot","三十二层巧克力棉花糖夹心饼干","smore/thirty_two");
    public static final ItemEntry<Item> SMORE_SIXTY_FOUR = item("smore_sixty_four","Stack-o'-S'more HexecontatessaraS'mingot" ,"六十四层巧克力棉花糖夹心饼干","smore/sixty_four");
    public static final ItemEntry<Item> SMOGUS       = item("smogus"      ,"S'mogus S'mingot"          ,"牛奶巧克力棉花糖夹心内鬼饼干"    ,"smore/gusone"      );
    public static final ItemEntry<Item> SMOGUS_TWO   = item("smogus_two"  ,"MultiS'mogus GrandS'mingot","多重牛奶巧克力棉花糖夹心内鬼饼干","smore/gustwo"      );
    public static final ItemEntry<Item> SMOGUS_FOUR  = item("smogus_four" ,"AllS'mogus OmniS'mingot"   ,"全能牛奶巧克力棉花糖夹心内鬼饼干","smore/gusfour"     );
    public static final ItemEntry<Item> SMOGUS_HEART = item("smogus_heart","Heart of the S'mogus"      ,"夹心内鬼饼干之心"                ,"smore/smogus_heart");

    //sorbet
    public static final ItemEntry<Item> SORBET         = item("sorbet"        ,"Plain Sorbet"  ,"原味雪葩"      ,"sorbet/plain"  );
    public static final ItemEntry<Item> SORBET_APPLE   = item("sorbet_apple"  ,"Apple Sorbet"  ,"苹果雪葩"      ,"sorbet/apple"  );
    public static final ItemEntry<Item> SORBET_APRICOT = item("sorbet_apricot","Apricot Sorbet","杏子雪葩"      ,"sorbet/apricot");
    public static final ItemEntry<Item> SORBET_CHORUS  = item("sorbet_chorus" ,"Chorus Sorbet" ,"紫颂果雪葩"    ,"sorbet/chorus" );
    public static final ItemEntry<Item> SORBET_GRAPE   = item("sorbet_grape"  ,"Grape Sorbet"  ,"葡萄雪葩"      ,"sorbet/grape"  );
    public static final ItemEntry<Item> SORBET_LIME    = item("sorbet_lime"   ,"Lime Sorbet"   ,"酸柠雪葩"      ,"sorbet/lime"   );
    public static final ItemEntry<Item> SORBET_VIBRANT = item("sorbet_vibrant","Vibrant Sorbet","Vibrant Sorbet","sorbet/vibrant");
    ...
    public static final ItemEntry<Item> BEEF_SLICE = item("beef_slice","Beef Slice","牛肉片");
    ...
    public static final ItemEntry<Item> CHOCOLATE = item("chocolate","Milk Chocolate","牛奶巧克力");
    public static final ItemEntry<Item> CHUM        = item("chum"       ,"Chum"                 ,"海霸糊"    );
    public static final ItemEntry<Item> CHUM_BUCKET = item("chum_bucket","Chum Bucket Kebab Mix","烤海霸拌桶");
    public static final ItemEntry<Item> CHUM_STICK  = item("chum_stick" ,"Chum on a Stick"      ,"海霸糊棒"  );
    ...
    public static final ItemEntry<Item> GRAHAM_CRACKER = item("graham_cracker","Graham Cracker","全麦饼干");
    public static final ItemEntry<Item> GUMMY_BEAR = item("gummy_bear","Gummy Bear","小熊软糖");
    public static final ItemEntry<Item> HOT_BEETROOT_SOUP = item("hot_beetroot_soup","Hot Beetroot Soup","热甜菜汤");
    public static final ItemEntry<Item> HOT_MUSHROOM_STEW = item("hot_mushroom_stew","Hot Mushroom Stew","热蘑菇煲");
    public static final ItemEntry<Item> HOT_RABBIT_STEW   = item("hot_rabbit_stew"  ,"Hot Rabbit Stew"  ,"热兔肉煲");
    ...
    public static void init() {
        TEST_ITEM_2 = item("test_item_2","utility/test_item_2");
        ...
        TEST_ITEM = REGISTRATE.item("test_item",Item::new)
                .model((ctx,prov)->
                        prov.generated(ctx::getEntry,prov.modLoc("item/utility/test_item")))
                .defaultLang()
